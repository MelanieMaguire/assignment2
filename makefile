main.x: main.o PoweredVehicle.o Vehicle.o Car.o Bicycle.o Jet.o Skateboard.o Motorcycle.o
	g++ -o main.x main.o PoweredVehicle.o Vehicle.o Car.o Bicycle.o Jet.o Skateboard.o Motorcycle.o  -std=gnu++11

main.o: main.cpp
	g++ -c main.cpp -std=gnu++11

Motorcycle.o: Motorcycle.cpp Motorcycle.h Vehicle.o
	gcc -c Motorcycle.cpp -std=gnu++11
